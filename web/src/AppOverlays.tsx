  ...
  <>
    {workspacePath ? (
      /* Dormant Task Graph/Blueprint surface. App passes `open=false` while
         TASK_GRAPH_PRIMARY_ENTRY_ENABLED is disabled; keep it wired so existing
         workspaces and future reactivation have a tested path. */
    ...
    {wizardOpen ? (
      <Suspense fallback={null}>
        <FirstRunWizard open={wizardOpen} onClose={onCloseWizard} onAddWorkspace={onAddWorkspace} />
      </Suspense>
    ) : null}
  </>
)
