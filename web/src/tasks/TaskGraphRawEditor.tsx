...
export const TaskGraphRawEditor = ({
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    // Failures surface through the conflict banner / console, never as an
    // unhandled rejection (the hook rolls local state back before throwing).
    onSave().catch((error: unknown) => {
      console.error('[gachi] swallowed:tasks.rawSave', error)
    })
  }
  return (
