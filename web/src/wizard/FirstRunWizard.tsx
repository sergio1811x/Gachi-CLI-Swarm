...
export const FirstRunWizard = ({ open, onClose, onAddWorkspace }: FirstRunWizardProps) => {
  const { t } = useI18n()
        ...
        <div className="pointer-events-none fixed inset-0 z-50 grid place-items-center p-4">
          ...
          >
            <Dialog.Description className="sr-only">
              {t('firstRun.step', { current: slideIdx + 1, total: totalSlides })}
            </Dialog.Description>
            ...
            <div className="min-h-[200px]">
              ...
              {slideIdx === 2 && (
                <div className="flex flex-col gap-3 py-2">
                  <h2 className="text-lg font-semibold text-pri">{t('firstRun.safetyTitle')}</h2>
                  <p className="text-sm text-sec">{t('firstRun.safetyBody')}</p>
                </div>
              )}
            ...
            <div className="mt-5 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                {!isLastSlide && (
                  ...
                  >
                    {slideIdx === 2 ? t('firstRun.safetyAck') : t('firstRun.next')}
                  </button>
                )}
                <button
                  type="button"
