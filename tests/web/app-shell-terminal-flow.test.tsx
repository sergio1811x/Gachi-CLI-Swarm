...
beforeEach(async () => {
  ...
  workspacePath = mkdtempSync(join(tmpdir(), 'gachi-app-shell-terminal-flow-'))
  mkdirSync(workspacePath, { recursive: true })
  tempDirs.push(workspacePath)
  process.env.GACH_FS_BROWSE_ROOT = workspacePath
...
describe('app shell terminal flow with real server', () => {
  ...
  test('keeps a late shell start response out of the workspace selected afterward', async () => {
    const betaPath = mkdtempSync(join(tmpdir(), 'gachi-app-shell-terminal-flow-beta-'))
