...
describe.skipIf(SKIP_CONPTY_WINDOWS)('workspace delete API', () => {
  test('DELETE /api/workspaces/:id stops active agents and removes workspace records only from Gachi CLI Swarm', async () => {
